...
class TestModelManagerCustomProviders:
    ...
    def test_load_custom_providers(self, mock_get_prefs):
        ...
        assert manager._custom_providers["provider1"]["api_base"] == "https://api1.com/v1"

    @patch("mcp_cli.model_manager.get_preference_manager")
    ...
    def test_add_runtime_provider(self):
        ...
        assert manager._custom_providers["runtime-ai"]["api_base"] == "https://runtime.com/v1"
    ...
    def test_add_runtime_provider_no_models(self):
        ...
        assert manager._custom_providers["runtime-ai"]["models"] == ["gpt-4", "gpt-3.5-turbo"]
    ...
    @patch("mcp_cli.model_manager.OpenAI")
    ...
    def test_get_client_with_custom_provider(self, mock_get_client):
        ...
        with patch.object(manager, "_get_custom_provider_client") as mock_custom:
            ...
            # Should call custom provider method
            mock_custom.assert_called_once_with("customai", None)
