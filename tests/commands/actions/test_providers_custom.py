...
class TestCustomProviderCommands:
    ...
    @patch("mcp_cli.commands.actions.providers.get_preference_manager")
    ...
    def test_add_custom_provider_success(self, mock_output, mock_get_prefs):
        ...
        mock_output.print.assert_any_call("   [bold]export TESTAI_API_KEY=your-api-key[/bold]")
    ...
    @patch("mcp_cli.commands.actions.providers.get_preference_manager")
    @patch("mcp_cli.commands.actions.providers.output")
    def test_list_custom_providers_empty(self, mock_output, mock_get_prefs, mock_format):
    ...
    @patch("mcp_cli.commands.actions.providers.get_preference_manager")
    @patch("mcp_cli.commands.actions.providers.output")
    def test_list_custom_providers_with_providers(self, mock_output, mock_get_prefs, mock_format):
    ...
    async def test_provider_action_add_command(self, mock_model_manager, mock_get_context):
        """Test provider action with add command."""
        mock_context = MagicMock()
        mock_get_context.return_value = mock_context
        
        with patch("mcp_cli.commands.actions.providers._add_custom_provider") as mock_add:
            await provider_action_async(["add", "testai", "https://api.test.com/v1", "gpt-4"])
    ...
    @patch("mcp_cli.commands.actions.providers.get_context")
    @patch("mcp_cli.commands.actions.providers.ModelManager")
    async def test_provider_action_remove_command(self, mock_model_manager, mock_get_context):
        """Test provider action with remove command."""
        mock_context = MagicMock()
        mock_get_context.return_value = mock_context
        
        with patch("mcp_cli.commands.actions.providers._remove_custom_provider") as mock_remove:
    ...
    @patch("mcp_cli.commands.actions.providers.get_context")
    @patch("mcp_cli.commands.actions.providers.ModelManager")
    async def test_provider_action_custom_command(self, mock_model_manager, mock_get_context):
        """Test provider action with custom command."""
        mock_context = MagicMock()
        mock_get_context.return_value = mock_context
        
        with patch("mcp_cli.commands.actions.providers._list_custom_providers") as mock_list:
    ...
    @patch("mcp_cli.commands.actions.providers.get_context")
    @patch("mcp_cli.commands.actions.providers.ModelManager")
    async def test_provider_action_add_missing_args(self, mock_model_manager, mock_get_context, mock_output):
