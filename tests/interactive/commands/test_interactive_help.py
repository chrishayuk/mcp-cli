...
class TestInteractiveHelpCommand:
    ...
    def setup_registry(self):
        ...
        another_cmd = DummyCommand("another", "Another test command with longer help text")
    ...
    async def test_execute_with_multiple_args(self, mock_help_action, help_command):
        ...
        result = await help_command.execute(["test", "extra", "args"], tool_manager=None)
    ...
    async def test_help_action_integration(self, mock_output, mock_format_table, help_command):
        ...
        assert mock_format_table.called or mock_output.warning.called or mock_output.print_table.called
        assert result is None

    @pytest.mark.asyncio
    @patch("mcp_cli.commands.help.format_table")
    @patch("mcp_cli.commands.help.output")
    async def test_show_all_commands(self, mock_output, mock_format_table, help_command):
