...
def test_build_mapping_single():
    ti = ToolInfo(
        name="t1", namespace="ns", description="", parameters={}, is_async=False
    )
...
def test_build_mapping_multiple():
    tools = [
        ToolInfo(
            name="foo", namespace="a", description=None, parameters=None, is_async=False
        ),
        ToolInfo(
            name="bar", namespace="b", description=None, parameters=None, is_async=False
        ),
        ToolInfo(
            name="baz", namespace="a", description=None, parameters=None, is_async=False
        ),
    ]
