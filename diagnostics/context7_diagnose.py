...
async def test_context7_detailed():
    ...
    try:
        ...
        if result.success and result.result:
            ...
            print(f"❌ Tool execution failed or returned empty result")
        ...
        if result.success and result.result and isinstance(result.result, str):
            ...
            for line in lines:
                if '/' in line and not line.startswith('Each') and not line.startswith('-'):
            ...
            if library_id:
                ...
                if docs_result.success and docs_result.result:
                    ...
                    print(f"❌ Documentation retrieval failed")
            else:
                print(f"⚠️  Could not extract library ID from resolve result")
