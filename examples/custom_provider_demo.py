...
async def demo_custom_provider():
    ...
    output.print()
    output.info("This demo shows how to add, use, and remove custom OpenAI-compatible providers.")
    ...
    output.info("In a real application, you could add multiple models programmatically.")
