...
from chuk_term.ui import output, theme
...
async def demo_interactive_prompts():
    ...
    output.print(
        "[cyan]Do you want to execute this tool? (Y/n)[/cyan] [dim](simulated: Y)[/dim]"
    )
...
async def demo_structured_output():
    ...
    tool_result = {
        "success": True,
        "data": {"files": ["main.py", "config.json", "README.md"], "count": 3},
