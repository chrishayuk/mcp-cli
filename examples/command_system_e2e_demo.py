...
from chuk_term.ui import output, clear_screen, format_table
...
class CommandSystemE2EDemo:
    ...
    def test_command(self, command: str, description: str, expect_in_output: List[str] = None):
    ...
    def run_demo(self):
        ...
        self.demo_section(
            "1. Help System",
            "Testing help commands with subcommand indicators"
        )
        ...
        self.demo_section(
            "2. Model Management",
            "Testing direct model switching and subcommands"
        )
        ...
        self.demo_section(
            "3. Provider Management",
            "Testing provider switching and commands"
        )
        ...
        self.demo_section(
            "5. Tool Management",
            "Testing tool discovery and management"
        )
        ...
        self.demo_section(
            ...
            "Testing theme and other UI commands"
        )
        ...
        self.demo_section(
            "7. Command Menu",
            "Testing slash-only command menu"
        )
