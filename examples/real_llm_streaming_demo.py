...
async def real_llm_streaming_demo():
    ...
    mcp_cli_path = Path(__file__).parent.parent / "src" / "mcp_cli"
...
async def simple_integration_test():
    ...
    display.show_assistant_message("Perfect! I used the echo tool to repeat your message. The integration works flawlessly!", 4.2)
