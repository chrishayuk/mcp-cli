...
from mcp_cli.commands.base import CommandMode, CommandGroup, CommandParameter
    ...
    def _register_command(app: typer.Typer, command: Any) -> None:
        ...
        def create_typer_command():
            ...
            def wrapper(**kwargs):
                ...
                result = asyncio.run(CLICommandAdapter._execute_command(command, kwargs))
        ...
        for alias in command.aliases:
            app.command(name=alias, help=command.description, hidden=True)(typer_command)
