...
"""
    ...
    async def execute(self, **kwargs) -> CommandResult:
        ...
        if not interrupted_something and hasattr(chat_context, "is_executing_tool") and chat_context.is_executing_tool:
        ...
        if not interrupted_something and hasattr(chat_context, "cancel_current_operation"):
