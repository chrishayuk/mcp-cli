...
class UnifiedCommandRegistry:
    ...
    def get(self, name: str, mode: Optional[CommandMode] = None) -> Optional[UnifiedCommand]:
        """
    ...
    def get_command_names(self, mode: Optional[CommandMode] = None, include_aliases: bool = False) -> List[str]:
        """
