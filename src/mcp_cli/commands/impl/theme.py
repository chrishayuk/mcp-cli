# src/mcp_cli/commands/impl/theme.py
"""
...
"""
    ...
    def parameters(self) -> List[CommandParameter]:
        return [
            CommandParameter(
                ...
                choices=["default", "dark", "light", "minimal", "terminal", "monokai", "dracula", "solarized"],
            ),
        ]
    ...
    async def execute(self, **kwargs) -> CommandResult:
        ...
        from mcp_cli.commands.theme import _interactive_theme_selection
