# src/mcp_cli/commands/impl/model.py
"""
...
Usage:
  /model list          - List all models (chat mode)
  model list           - List all models (interactive mode)
  mcp-cli model list   - List all models (CLI mode)
